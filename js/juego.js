...
var instrucciones = ["Mover pieza a pieza", "Acomodar imagenes correctamente", "Formar imagen completa"];
...
function agregaUltimoMovimientoAMovimientos(direccion) {
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  /*
  var valorGrillaTemp;
  valorGrillaTemp = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = valorGrillaTemp;
  */
...
function moverEnDireccion(direccion) {
  ...
  // Mueve pieza hacia la derecha, reemplazandola con la blanca
    ...
    nuevalFilaPiezaVacia = filaVacia;
  ...
  if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)) {
    ...
    agregaUltimoMovimientoAMovimientos(direccion);
